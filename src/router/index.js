...
const quotationStore = r => require(['@/components/home/offer/quotationStore'], r);
const quotationDetails = r => require(['@/components/home/offer/quotationDetails'], r); //商户中心-商品
...
const customProductEdit = r => require(['@/components/home/goods/children/customProductEdit/customProductEdit'], r);
...
const offer = r => require(['@/components/home/offer/offer'], r);//报价
const offerManage = r => require(['@/components/home/offer/children/offerManage'], r);

const releaseProduct = r => require(['@/components/home/goods/children/releaseProduct'], r);
const customProduct = r => require(['@/components/home/goods/children/customProduct'], r);
const customProductList = r => require(['@/components/home/goods/children/customProductList'], r);
...
import cityFour from '../common/cityFour.vue'; //省市区三级联查
Vue.component('city-four', cityFour);
