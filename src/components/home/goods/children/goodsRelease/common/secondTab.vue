              ...
              <div class="z_info">
                ...
                <!-- <div class="market_price z_price">
                 ...
                 <div class="goods_number">
                  <span><b class="red">*</b> 设置批发价格： </span>
                  <!-- <el-input v-model="numberGD1" :maxlength="40" size="medium" style="width: 150px;" placeholder="请填写数量" clearable>
                  </el-input>
                  <el-input v-model="numberGD2" :maxlength="40" size="medium" style="width: 150px; margin-left:20px;" placeholder="请填写价格" clearable>
                  </el-input>
                  <el-button style="margin-left:20px" type="info" @click="addFind0" plain>+ 添加</el-button> -->
                  <div class="add_input" v-for="(find0, index) in finds0" :key="index">
                    <el-input v-model="find0.number" :maxlength="40" size="medium" style="width: 150px;" placeholder="请填写数量" clearable>
                    </el-input>
                    <el-input v-model="find0.order_price" :maxlength="40" size="medium" style="width: 150px; margin-left:20px;" placeholder="请填写价格" clearable>
                    </el-input>
                  </div>
                  <el-button style="margin-top:10px; margin-left: 95px;" type="info" @click="addFind0" plain>+ 添加</el-button>
                </div>
    ...
    <label for="checkbox2"><span>Checkbox</span></label>
              ...
              <div class="z_info" style="">
                <div class="goods_classify" style="margin: 10px 0;">
                  ...
                  <p class="cue cue1" style="padding-left: 77px; margin-top: 50px;">
...
export default {
    ...
    methods: {
      addFind0: function () {
        this.finds0.push({ number: '', order_price: '' });
      },
      btnClick1(val) {
          if(val) {
              // $(".formData").val(val)
      ...
      getSpecItem() {
        this.$HTTP(
          ...
          { spec: this.specResult, goods_id: this.goodsId },
          "post"
        )
          .then(res => {
            $(".g_editss").html("");
      ...
      addItem(parentData, index) {
        ...
        addGoods() {
            ...
            // var numGD1 = [[this.numberGD1, this.finds0]]
			      // var numGD2 = [[this.numberGD2, this.finds0]]
            // var numGD = {
            //   number: numGD1,
            //   order_price: numGD2
            // }
            // console.log(222, numGD)
            ...
            data += "&title=" + this.title + "&code=" + this.code + "&detail=" + this.getUEContent() + "&description=" + this.description + "&keyword=" + this.keyword + "&siteTitle=" + this.siteTitle + "&num=" + this.finds0 + "&item=" + inputList
          ...
          if (!this.title) {
            ...
            dataJson['keyword'] = this.keyword;
            dataJson['siteTitle'] = this.siteTitle;
            dataJson['num'] = this.finds0;
            dataJson['item'] = inputList;
