<template>
    ...
    <div class="shopManage fl">
        <h1 class="titles size16">审核中商品-列表</h1>
        <div class="notes-box">
            <div class="notes_title">温馨提示</div>
            <div class="notes_content">
                <p>1.该列表的商品处于平台审核状态，一般为72小时内</p>
                <p>
                    2.审核中的商品可进行编辑和删除
                </p>
            </div>
        ...
        <div class="order_minute">
            <div class="shop" v-for="(item, index) in goodsData" :key="index" v-if="item.shelves == 0 && item.approval_status == 0">
                <div class="minute_g">
