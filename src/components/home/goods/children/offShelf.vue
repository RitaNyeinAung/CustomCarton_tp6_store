<template>
    ...
    <div class="shopManage fl">
        <h1 class="titles size16">下架的商品-列表</h1>
        <div class="notes-box">
            <div class="notes_title">温馨提示</div>
            <div class="notes_content">
                <p>1.该列表的商品处于下架状态</p>
                <p>
                    2.点击操作栏的“出售中/已下架"可以直接切换状态 
                </p>
                <p>3.当商品重新编辑，会进入重新审核状态</p>
            </div>
        </div>
        ...
        <div class="order_minute">
            <div class="shop" v-for="(item, index) in goodsData" :key="index" v-if="item.shelves == 0 && item.approval_status == 1">
                <div class="minute_g">
