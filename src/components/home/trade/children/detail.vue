    ...
    <div class="deliver-goods">
        ...
        <div class="t_tab">
            ...
            <div class="reasonPart" >
                <el-input type="textarea" :rows="5" class="reasoninput" v-model="reason" clearable placeholder="拒绝理由">
                </el-input>
                <el-button @click="reasonClick" size="small" type="success" class="reasonBtn">
                    拒绝订单
                </el-button>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            reasonClick() {
                this.$HTTP(this.$httpConfig.orderRefuse, {id: this.$route.params.order_id, reason: this.reason}).then((res) => {
                    this.$message({
                        duration: 1000,
                        type: 'success',
