        ...
        <div class="index-left">
            <div class="commodity">
                ...
                <ul>
                    <li>
                        <el-badge
                            @click.native="commonOperations(1)"
                            class="item"
                        >
                            <el-button size="small">询价报价</el-button>
                        </el-badge>
                    </li>
                  <li>
                    <el-badge
                        @click.native="commonOperations(2)"
                        class="item"
                    >
                      <el-button size="small">报价列表</el-button>
                    </el-badge>
                  </li>
                  <li>
                    <el-badge
                        @click.native="commonOperations(3)"
                        class="item"
                    >
                      <el-button size="small">定制商品发布</el-button>
                    </el-badge>
                  </li>
                  <li>
                    <el-badge
                        @click.native="commonOperations(4)"
                        class="item"
                    >
                      <el-button size="small">定制商品管理</el-button>
                    </el-badge>
                  </li>
                </ul>
            </div>
            ...
            <ul>
              <li>
                <el-badge
                    @click.native="tolink(1)"
                    class="item"
                >
                  <el-button size="small">标准商品发布</el-button>
                </el-badge>
              </li>
              <li>
                <el-badge
                    @click.native="tolink(2)"
                    :value="goods.inTheWarehouse"
                    :max="99"
                    class="item"
                >
                  <el-button size="small">标准商品管理</el-button>
                </el-badge>
              </li>
              <li>
                <el-badge
                    @click.native="tolink(3)"
                    class="item"
                >
                  <el-button size="small">标准商品咨询</el-button>
                </el-badge>
              </li>
              <li>
                <el-badge
            ...
            <div class="commodity">
                ...
                <ul>
                    <li>
                        <el-badge
                            @click.native="service"
                            class="item"
                        >
                            <el-button size="small">客服列表</el-button>
                        </el-badge>
                    </li>
                </ul>
            </div>
...
export default {
    ...
    methods: {
        LinkOpen(annId) {
            ...
            window.open("http://demo.gtpacking.cn/notice/"+annId);
        },
        // dateFormat() {
        ...
        tolink(index) {
          if (index == 1) {
            parent.location.href = "#/goods?type=goodsRelease";
          }else if(index == 2){
            parent.location.href = "#/goods?type=goodsManage";
          }else if(index == 3){
            parent.location.href = "#/goods?type=askQuestion";
          }else if(index == 4){
        ...
        commonOperations(index){
          if (index == 1) {
            parent.location.href = "#/offer?type=inquiryPurchase";
          }else if(index == 2){
            parent.location.href = "#/offer?type=offerManage";
          }else if(index == 3){
            parent.location.href = "#/goods?type=customProduct";
          }else if(index == 4){
            parent.location.href = "#/goods?type=customProductList";
          }
        ...
        orderFun(state){
          if (state == 0) {
            ...
            parent.location.href = "#/trade?type=invoice";
          }else if(state == 2){
            parent.location.href = "#/trade?type=evaluate";
          }else if(state == 3){
            parent.location.href = "#/trade?type=refund";
          }
