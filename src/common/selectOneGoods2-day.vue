<template>
    <div>
        ...
        <el-form-item :label="listTitle">
            <el-table v-if="salePro == true" :data="updateGoods" border style="width: 70%;">
            ...
            <el-table v-else-if="!status" :data="hasCityData" border style="width: 70%;">
                <el-table-column prop="id" label="ID">
                </el-table-column>
                <el-table-column show-overflow-tooltip prop="title" label="商品名称">
                </el-table-column>
        ...
        <el-form-item :label="listTitle1">
            <el-table v-if="salePro == true" :data="updateGoodsChild" border style="width: 70%;">
                <el-table-column prop="id" label="ID">
                </el-table-column>
                <el-table-column show-overflow-tooltip prop="title" label="商品名称">
                </el-table-column>
            ...
            <el-table v-else-if="!status" :data="hasCityDataChild" border style="width: 70%;">
                <el-table-column prop="id" label="ID">
                </el-table-column>
                <el-table-column show-overflow-tooltip prop="title" label="商品名称">
                </el-table-column>
...
export default {
    ...
    created() {
        if(this.salePro && this.salePro == true) {
            // alert('created' + JSON.stringify(this.sendUpdateData))
            this.sendUpdateData1()
        }
    },
    watch: {
        sendStatus() {
    ...
    methods: {
        sendUpdateData1() {
            ...
            this.updateGoodsChild = []
            this.updateGoodsChild = this.updateGoods[0].GoodsSpec
            // alert(JSON.stringify(this.updateGoodsChild))
            // [{  
            //     "loop":"22",
            //     "data":[{
            //         "id":"30","title":"美肤宝美白隔离防晒霜SPF40保湿洁肤晶露60ml","price_market":"100.00","price_member":"95.00","stock":"99",
            //         "GoodsSpec":[
            //             {"id":"31","title":"美肤宝美白隔离防晒霜SPF40保湿洁肤晶露60ml F调","price_member":"0.05","stock":"76","price_market":"100.00","item":"F调"},
            //             {"id":"32","title":"美肤宝美白隔离防晒霜SPF40保湿洁肤晶露60ml G调","price_member":"95.00","stock":"99","price_market":"100.00","item":"G调"},
            //             {"id":"115","title":"萧紫竹单插白铜双节八孔箫 绿色补水","price_member":"68.00","stock":"1010","price_market":"80.00","item":"绿色补水"},
            //             {"id":"116","title":"萧紫竹单插白铜双节八孔箫 粉色提亮","price_member":"70.00","stock":"1400","price_market":"80.00","item":"粉色提亮"}
            //         ]
            //     }],
            //     "childData":["31","32"]
            // }]
            // for(let i = 0; i < this.sendUpdateData.length; i++) {
            //     alert(JSON.stringify(this.sendUpdateData[i].childData))
                // alert(JSON.stringify(this.sendUpdateData[i]))
                // for(let ii = 0; ii < this.updateGoods[i].childData.length; ii++) {
                //     // if(this.updateGoodsChild[i].isAdded == true) {
                //         alert(this.updateGoods[i].childData[ii])
                //         this.checkList.push(this.updateGoodsChild[i].childData[ii])
                //     // }
                // }
            // }
        ...
        submitSelect() {
            ...
            console.log("sss " + JSON.stringify(this.multipleSelection))
