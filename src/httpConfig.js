...
const request = 'https://api.yisample.com/custom-merchant/public/index.php/';
// const request = 'http://www.cartonAgent.net/';

// const imgRequest = "http://center.shopsn.cn/";
const imgRequest = "https://admin.yisample.com/";
...
const config = {
  ...
  */
  ...
  //news
  customTemplateList: request + 'CustomTemplate/customTemplateList',
  customTemplateDetail: request + 'CustomTemplate/customTemplateDetail',
  addCustomInfo: request + 'Goods/addCustomInfo',
  projiectList: request + 'Project/projiectList',
  projectDetail: request + 'Project/projectDetail',
  offerList: request + 'Offer/offerList',
  offerDetail: request + 'Offer/offerDetail',
  offerAdd: request + 'Offer/offerAdd',
  ...
  storeLogoCofig: imgRequest + uploadImage + 'FileUpload/getStoreLogoConfig', //获取商品图片配置
  ...
  customGoodsList: request + 'Goods/customGoodsList',
  customizedDetail: request + 'Goods/customizedDetail',
  customizedDetailById: request + 'Goods/customizedDetailById',
  customizedModify: request + 'Goods/customizedModify',
  customDel: request + 'Goods/customDel',
  orderRefuse: request + 'Order/orderRefuse',
  ...
  getAddressListSearch: request + 'Logistics/shippingAddressList', //搜索
  ...
  getExpressListSearch: request + 'Express/freightList', //列表搜索
  ...
  */
  ...
  getStoreLogo: request + 'Store/getStoreLogo',//修改店铺信息
  ...
  saveService: request + 'Service/saveService', //添加和修改
  addServiceConver: request + 'Service/adminList', //管理员列表
   ...
   */
  // 广告列表
  getAdvList: request + 'StoreAdv/adList',//列表
  ...
  getRegionArea: request + 'Region/regionLists', //获取市和区
